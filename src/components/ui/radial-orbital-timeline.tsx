...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-[800px] flex flex-col items-center justify-center bg-transparent overflow-hidden"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-24 h-24 rounded-full bg-gradient-to-br from-red-600 via-red-500 to-orange-500 animate-pulse flex items-center justify-center z-10">
